...
## Решение
<a href="https://github.com/Nephedov/3.Java/blob/main/src/Main.java">Main.java</a>.

## Что было сделано
* Реализован код согласно условию.

---
---


## Описание Задания 1. «Получи рубль за каждые 100» (обязательное к выполнению)
